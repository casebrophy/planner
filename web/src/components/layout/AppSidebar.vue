...
<template>
  ...
  >
    ...
    <div class="flex items-center h-14 px-4 border-b border-gray-800">
      ...
      <span v-if="!collapsed" class="ml-3 text-lg font-semibold text-gray-100">Planner</span>
    </div>
    ...
    <nav class="flex-1 py-4 space-y-1 px-2">
      ...
      >
        ...
        <svg v-else-if="item.icon === 'check-square'" class="w-5 h-5 shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <svg v-else-if="item.icon === 'plus-circle'" class="w-5 h-5 shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
